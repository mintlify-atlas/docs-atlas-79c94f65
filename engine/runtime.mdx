...
description: "Reference for GameState fields, Phase and GameOutcome enums, every actions:: function signature, ShellOutput, asset sources, and the detection model."
---
