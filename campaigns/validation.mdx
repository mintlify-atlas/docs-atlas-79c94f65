---
title: "Validating Campaigns with --check and --doctor"
...
| Duplicate trigger across commands | The same trigger string appears in more than one `CampaignCommand` or more than one `TerminalCommand`. |
