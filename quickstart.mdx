---
title: "Get Started with Simterm in 5 Minutes"
...
Simterm plays looped WAV audio when a campaign provides `music/mission_N_theme.wav` files alongside `campaign.ron`. Pass `--no-music` to silence it regardless.
